...
namespace svg {
    ...
    struct RenderContext {
        ...
        RenderContext(std::ostream& out, int indent_operation, int indent = 0)
            : out(out)
            , indent_operation(indent_operation)
            , indent(indent) {
        }

        RenderContext Indented() const {
            return { out, indent_operation, indent + indent_operation };
        }
